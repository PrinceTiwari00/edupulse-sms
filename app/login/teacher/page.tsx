...
import { User, Eye, EyeOff, School, ArrowRight, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex items-center justify-center p-6 bg-slate-50">
      <div className="w-full max-w-[450px] bg-white rounded-[32px] border border-slate-100 shadow-2xl p-10 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-500 font-medium">Access your classes and student records</p>
        </div>

        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          <div className="space-y-1.5">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Staff ID / Username</label>
